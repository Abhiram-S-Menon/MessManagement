    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.HostelName=Input.HostelName;
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        if (_userManager.IsInRoleAsync(user, SD.Role_Member).GetAwaiter().GetResult())
                        {
                            return RedirectToAction("Index", "MessMember");
                        }
                        else
                        {
        ...
        private MessMember CreateUser()
        {
            try
            {
                return Activator.CreateInstance<MessMember>();
            }
            catch
            {
